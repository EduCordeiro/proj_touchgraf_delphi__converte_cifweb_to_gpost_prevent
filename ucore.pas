...
//  ForceDirectories(sPathmovimentoCIF);
  ...
  begin
    ...
    Begin
      ...
      sTipoRegistro                     := copy(sLinha, 1, 1);

      if sTipoRegistro = '1' then
      begin
  ...
  stlRelatorioObjRetidosAnalitico.Add('LOTE  SEQUENCIA ');
  ...
  //====================================================================================
   ...
   Begin
     ...
     //========================================================================================
     sComando := 'SELECT  NUMERO_LOTE, SEQUENCIA_OBJETO FROM ' + objParametrosDeEntrada.TABELA_PROCESSAMENTO
               + ' WHERE NUMERO_CARTAO = "' + sNumeroCartao + '"'
               + '   AND NUMERO_LOTE   = "' + sLoteFAC + '"'
               + '   AND CEP_STATUS    <> "01" '
               + ' ORDER BY SEQUENCIA_OBJETO ';
     ...
     while not __queryMySQL_processamento2__.Eof do
     Begin
       stlRelatorioObjRetidosAnalitico.Add(__queryMySQL_processamento2__.FieldByName('NUMERO_LOTE').AsString + ' ' + __queryMySQL_processamento2__.FieldByName('SEQUENCIA_OBJETO').AsString);
       __queryMySQL_processamento2__.Next;
     end;
